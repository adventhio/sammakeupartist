            ...
            <div class="checkout-payment checkout-form">
                ...
                <?php foreach ($data_rekening as $row) { ?>
                    <div class="checkout-payment__item">
                        ...
                        <?php echo form_open_multipart('myorder/bayardp', ['onsubmit' => 'return showSuccessMessage()']); ?>
                        <div class="checkout-payment__item-content">
                            ...
                            <div class="box-field" style="margin-top: 10px;">
                                <span>Masukkan Nominal Pembayaran DP (masukan nominal saja tanpa Rp, titik, dan koma)</span>
...
<script>
    function showSuccessMessage() {
        alert("Transaksi DP Berhasil !! Silahkan Chat admin untuk mengkonfirmasi pesanan. silahkan hubungi nomor WhatsApps 0857 1914 5111");
