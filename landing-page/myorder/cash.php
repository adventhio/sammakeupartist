                    ...
                    <div class="checkout-payment__item">
                        ...
                        <div class="checkout-payment__item-content">
                            ...
                            <div class="box-field" style="margin-top: 10px;">
                                <span>Masukkan Nominal Pembayaran (masukan nominal saja tanpa Rp, titik, dan koma)</span>
                            ...
                            <div class="checkout-buttons">
                                ...
                                <button type="submit" class="btn btn-icon btn-next" onclick="showSuccessMessage()">Simpan <i class="icon-arrow"></i></button>
                            </div>
                        </div>
                        </form>
                    </div>
...
<script>
    function showSuccessMessage() {
        alert("Transaksi Berhasil !! Silahkan chat admin untuk mengkonfirmasi pesanan. Silahkan hubungi nomor WhatsApp 0857 1914 5111.");
    }
</script>
