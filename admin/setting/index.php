<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header border bottom">
            <h4 class="card-title">Ubah Informasi Akun</h4>
        </div>
        <div class="card-body">
            <?php if ($this->session->userdata('role') == 'Owner') { ?>
                <form method="POST" action="<?= base_url('owner/updateSetting') ?>" onsubmit="return validateForm()">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="p-h-10">
                                <div class="form-group">
                                    <label class="control-label">New Email</label>
                                    <input type="email" name="email" id="email" class="form-control" placeholder="New Email" value="<?= $this->session->userdata('email'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <?php } else { ?>
                <form method="POST" action="<?= base_url('setting/update') ?>" onsubmit="return validateForm()">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="p-h-10">
                                <div class="form-group">
...
function validateForm() {
    ...
    if (email && !password) {
        alert('PERBARUI DATA SECARA LENGKAP !');
        return false;
    }
    return true;
}
