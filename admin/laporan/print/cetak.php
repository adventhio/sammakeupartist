...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() . 'assets/assets-admin/images/logo2.png' ?>">
...
<body>
    <div style="text-align: center;">
        <img src="<?php echo base_url() . 'assets/assets-admin/images/logo2.png' ?>" width="200px" height="100px" />
    </div>
    <h1 style="text-align: center;">CETAK LAPORAN WEDDING ORGANIZER</h1>
    <div class="row" style="padding: 20px;">
        <div class=" col-6">
            <div>SAMmakeUP Artist</div>
            <div>Palumbonsari, Kec. Karawang Tim., Karawang, Jawa Barat 41314</div>
        </div>
        <div class=" col-6" style="text-align: right;">
            <!-- <div> </div> -->
            <div>Karawang</div>
            <div>0857 1914 5111</div>
            <div></div>
        </div>
    </div>
